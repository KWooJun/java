...
public class StringStudy {
    public static void main(String[] args) {
        ...
        //왼쪽에서 오른쪽 방향으로 가장 빨리찾은 index 값을 리턴

        System.out.println("마지막 .의 위치 값 : " + fileNm.lastIndexOf("."));
        ...
        System.out.println(str7.equalsIgnoreCase(str8)); // 대소무자 구분없이 같은지 비교

        System.out.println("------------------------------------");

        int n = 10;
        String str9 = n + "";
        String str10 = String.valueOf(n); //모든 타입을 String 으로 변경할 수 있다.
