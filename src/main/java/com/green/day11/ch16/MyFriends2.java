...
public class MyFriends2 {
    public static void main(String[] args) {
        ...
        //다형성 : 다양한 형태가 될 수 있는 성질 >> 변수타입은 객체는 다른데 저장할 수 있다.
        ...
        //Friend f2가 의미하는 바는 Friend 객체 주소값을 담을 수 있는 f2 래퍼런스 변수
        //이제는 + Friend 를 상속받은 객체의 주소값도 담을 수 있다.

        Friend[] arr3 = new Friend[10]; //arr3의 각 방의 타입 : Friend
        //UnivFriend2, ComFriend2, Friend 의 객체 주소값 모두 담을 수 있는 배열
        arr3[0] = obj1;
        arr3[1] = f2;
...
//CompFriend 와 같은 능력이 있는 2를 만들어주세여
